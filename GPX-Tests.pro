...
SOURCES += \
   ...
   # src/gpx-tests/minLatTests_N0720717.cpp \ - error in test suite
   # src/gpx-tests/numPositionsTests_n0719388.cpp \ - error in test suite
   # src/gpx-tests/maxElevation-n0686300.cpp \ - error in test suite
   # src/gpx-tests/totalTime-N0702007.cpp \ - error in test suite
   ...
   # src/gpx-tests/N0692013_minLongitude().cpp \ - error in test suite
   # src/gpx-tests/N0630057-MaxLatitudeTest.cpp - error in test suite

#src/gpx-tests/minLongitude_N0671080.cpp - has multiple errors
